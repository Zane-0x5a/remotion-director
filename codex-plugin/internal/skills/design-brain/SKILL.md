...
Read **`<PLUGIN_ROOT>/internal/skills/design-brain/reference/design-equipment.md`** completely and obey it. It carries, verbatim and load-bearing:
...
They live as siblings in `<PLUGIN_ROOT>/internal/skills/design-brain/reference/`, loaded on demand per §2's timing (you decide which axis to read as the design advances; do NOT bulk-read them as a checklist up front):
